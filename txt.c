...
void editorDrawRows(struct abuf *ab)
{
    ...
    for (y = 0; y < E.screenrows; y++)
    {
        ...
        if (filerow >= E.numrows)
        {
            ...
            {
                char welcome[80];
                int welcomelen = snprintf(welcome, sizeof(welcome), "\x1b[34mtxt editor ~~ Version %s\x1b[m", EDITOR_VERSION);
...
int main(int argc, char **argv)
{
    ...
    editorSetStatusMessage("HELP: ^S ~ Save | ^Q ~ Quit | ^U ~ Find");
